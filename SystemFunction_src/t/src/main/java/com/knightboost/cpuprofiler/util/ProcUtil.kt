...
import com.knightboost.cpuprofiler.core.ProcConst.PROC_NEWLINE_TERM
import com.knightboost.cpuprofiler.core.ProcConst.PROC_OUT_FLOAT
import com.knightboost.cpuprofiler.core.ProcConst.PROC_OUT_LONG
import com.knightboost.cpuprofiler.core.ProcConst.PROC_OUT_STRING
import com.knightboost.cpuprofiler.core.ProcConst.PROC_PARENS
import com.knightboost.cpuprofiler.core.ProcConst.PROC_SPACE_TERM
import com.knightboost.cpuprofiler.core.ProcConst.PROC_TAB_TERM
...
object ProcUtil {
    ...
    fun getMyProcTaskIds(): List<Long> {
        ...
        for (f in files) taskIds.add(f.name.toLong())
        return taskIds
    }
    ...
    fun readProcFile(
        ...
        try {
            ...
            for (format in formatArray) {
                ...
                if (format and PROC_PARENS == PROC_PARENS) procParens = true
    ...
    @JvmStatic
    fun parseProcLine(
        inputBytes: ByteArray, begin: Int, end: Int, formatArray: IntArray,
        outStrings: Array<String?>?, outLongs: LongArray?, outFloats: FloatArray?
    ): Boolean {
        var i = begin
        val byteBuffer = mutableListOf<Byte>()
